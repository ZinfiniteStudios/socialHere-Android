...
import com.david.socialhere.adapter.FoursqAdapter;
 ...
 */
public class FourSquareNearbyFragment extends BaseFragment {
                ...
                .setCallback(new FutureCallback<Response<String>>() {
                    ...
                    public void onCompleted(Exception e, Response<String> stringResponse) {
                        if (e != null) {
                            ...
                            FoursqAdapter foursqAdapter = new FoursqAdapter(mContext, places.getResponse().getVenues());
                            listView.setAdapter(foursqAdapter);
